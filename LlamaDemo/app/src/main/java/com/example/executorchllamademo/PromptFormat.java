...
public class PromptFormat {
  ...
  public static String getConversationFormat(ModelType modelType) {
    switch (modelType) {
      ...
      case QWEN:
        return getUserPromptTemplate(modelType) + ASSISTANT_PLACEHOLDER + "<|im_end|>\n";
      case GLM:
        return getUserPromptTemplate(modelType) + ASSISTANT_PLACEHOLDER;
      default:
        return USER_PLACEHOLDER;
    }
  }
